...
ROS_INFO("Going to the objective %d \n", waypoint_number +1);
...
//===================XXXXX
  ...
  ros:: NodeHandle  np;
  ros:: NodeHandle  nh;
  ros:: Publisher  pub_vel = nh.advertise <geometry_msgs ::Twist >("drone1/cmd_vel", 1);
  ros:: Subscriber  sub = np.subscribe("/drone1/ground_truth_to_tf/pose", 1000,  odoCallback);
