...
int main(int argc, char **argv)
{
  ...
  while (ros::ok())
  {
    ...
    if((ros::Time::now().toSec() - drone1->time) > 20 && (ros::Time::now().toSec() - drone1->time) < 30 && count < 2) {
      ...
      drone3->setTarget(drone3->mean_start_gps_x, drone3->mean_start_gps_y, drone1->mean_start_gps_alt + 1.5, 0.0);
      drone4->setTarget(drone4->mean_start_gps_x, drone4->mean_start_gps_y, drone1->mean_start_gps_alt + 1.5, 0.0);
      ++count;
  ...
  switch(drone1->state) {
    ...
    case 1:
      if(drone1->finished == false) {
        ...
        drone1->state = 3;
        drone1->setTarget(drone1->mean_start_gps_x - 2, drone1->mean_start_gps_y, drone1->mean_start_gps_alt + 1.5, 0.0); // drone1->target.x = -3;
        // drone1->target.y = 4.5;
        // drone1->target.z = -5;
    ...
    case 3:
      if(drone1->finished == false) {
        ...
        drone1->state = 4;
        drone1->setTarget(drone1->mean_start_gps_x - 2, drone1->mean_start_gps_y - 2, drone1->mean_start_gps_alt + 1.5, 0.0);
        drone1->reached_goal_ = false;
        drone1->finished = false;
    ...
    case 4:
      if(drone1->finished == false) {
        ...
        drone1->state = 5;
        drone1->setTarget(drone1->mean_start_gps_x, drone1->mean_start_gps_y - 2, drone1->mean_start_gps_alt + 1.5, 0.0);
        drone1->reached_goal_ = false;
        drone1->finished = false;
  ...
  switch(drone2->state) {
    ...
    case 1:
      if(drone2->finished == false) {
        ...
        drone2->state = 3;
        drone2->setTarget(drone2->mean_start_gps_x - 2, drone2->mean_start_gps_y, drone1->mean_start_gps_alt + 1.5, 0.0); // drone2->target.x = -3;
        // drone2->target.y = 4.5;
        // drone2->target.z = -5;
    ...
    case 3:
      if(drone2->finished == false) {
        ...
        drone2->state = 4;
        drone2->setTarget(drone2->mean_start_gps_x - 2, drone2->mean_start_gps_y - 2, drone1->mean_start_gps_alt + 1.5, 0.0);
        drone2->reached_goal_ = false;
        drone2->finished = false;
        ROS_INFO("Done with route 2");
      }
    ...
    case 4:
      if(drone2->finished == false) {
        ...
        drone2->state = 5;
        drone2->setTarget(drone2->mean_start_gps_x, drone2->mean_start_gps_y - 2, drone1->mean_start_gps_alt + 1.5, 0.0);
        drone2->reached_goal_ = false;
        drone2->finished = false;
        ROS_INFO("Done with route 3");
      }
  ...
  switch(drone3->state) {
    ...
    case 1:
      if(drone3->finished == false) {
        ...
        drone3->state = 3;
        drone3->setTarget(drone3->mean_start_gps_x - 2, drone3->mean_start_gps_y, drone1->mean_start_gps_alt + 1.5, 0.0); // drone3->target.x = -3;
        // drone3->target.y = 4.5;
        // drone3->target.z = -5;
    ...
    case 3:
      if(drone3->finished == false) {
        ...
        drone3->state = 4;
        drone3->setTarget(drone3->mean_start_gps_x - 2, drone3->mean_start_gps_y - 2, drone1->mean_start_gps_alt + 1.5, 0.0);
        drone3->reached_goal_ = false;
        drone3->finished = false;
        ROS_INFO("Done with route 2");
      }
    ...
    case 4:
      if(drone3->finished == false) {
        ...
        drone3->state = 5;
        drone3->setTarget(drone3->mean_start_gps_x, drone3->mean_start_gps_y - 2, drone1->mean_start_gps_alt + 1.5, 0.0);
        drone3->reached_goal_ = false;
        drone3->finished = false;
        ROS_INFO("Done with route 3");
      }
  ...
  switch(drone4->state) {
    ...
    case 1:
      if(drone4->finished == false) {
        ...
        drone4->state = 3;
        drone4->setTarget(drone4->mean_start_gps_x - 2, drone4->mean_start_gps_y, drone1->mean_start_gps_alt + 1.5, 0.0); // drone4->target.x = -3;
        // drone4->target.y = 4.5;
        // drone4->target.z = -5;
    ...
    case 3:
      if(drone4->finished == false) {
        ...
        drone4->state = 4;
        drone4->setTarget(drone4->mean_start_gps_x - 2, drone4->mean_start_gps_y - 2, drone1->mean_start_gps_alt + 1.5, 0.0);
        drone4->reached_goal_ = false;
        drone4->finished = false;
        ROS_INFO("Done with route 2");
      }
    ...
    case 4:
      if(drone4->finished == false) {
        ...
        drone4->state = 5;
        drone4->setTarget(drone4->mean_start_gps_x, drone4->mean_start_gps_y - 2, drone1->mean_start_gps_alt + 1.5, 0.0);
        drone4->reached_goal_ = false;
        drone4->finished = false;
        ROS_INFO("Done with route 3");
      }
